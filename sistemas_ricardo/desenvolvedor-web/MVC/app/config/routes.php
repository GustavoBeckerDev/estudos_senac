...
// Rotas de Produtos
$router->get('/produtos', 'ProdutosController@index'); // EXIBE VIEW DE LISTA DE PRODUTOS
$router->get('/produtos/cadastrar', 'ProdutosController@cadastrar'); // EXIBE VIEW DE CADASTRO
$router->get('/produtos/ver/{id}', 'ProdutosController@ver'); // EXIBE VIEW DE PRODUTO ESPECÍFICO
$router->post('/produtos/salvar', 'ProdutosController@salvar'); // EXIBE VIEW DE SALVAR
